...
describe("mission projections", () => {
  it("loads backend summary and events", async () => {
    ...
    globalThis.fetch = (async (input: RequestInfo | URL) => {
      ...
      if (url.endsWith("/run")) return new Response(JSON.stringify({ events_url: "/missions/m1/events", summary: { mission_id: "m1", mission_state: "VERIFY", incidents: {}, latest_tracks: {}, latest_threats: {}, commands: [], event_count: 1 } }), { status: 200 });
